...
**ii. Evaluation tasks**
To evaluate the effectiveness of the embeddings, the team used specific classification tasks:
- **Text**: Photo Caption Classification, Menu Item Classification, Business Property Classification, and Synonym Generation.
- **Photos**: 5-way Restaurant/Food/Nightlife classification, 27-class Food classification, and Home Services Contractor classification.
...
**i. Model Quality**
- **Zero-shot validation**: Comparing zero-shot predictions against hand-labeled datasets.
- **Threshold Tuning**: Balancing precision vs. recall via compatibility thresholds.
