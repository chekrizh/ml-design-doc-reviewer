...
**i. Error taxonomy**
- **Domain Mismatch**: Poor performance on graphics, cartoons, and symbols.
- **Semantic Gap**: Failure to recognize specific text or symbols within images.

**ii. Root cause analysis**
- **Training Data Bias**: DINOv2 was trained on LVD-142M, which consists primarily of photographs rather than symbolic or non-realistic imagery.
- **Task Mismatch**: DINOv2 is optimized for general object, texture, and scene categorization (via masked image modeling) rather than specific symbol recognition.
