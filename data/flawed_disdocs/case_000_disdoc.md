...
**i. Origin**
Swiggy is a data-driven company where business and product decisions rely heavily on specific quantitative metrics (e.g., customer impact during outages, Pseveral of customer claims). Traditionally, accessing this data required manual SQL writing or requesting pulls from data analysts.

**ii. Relevance & Reasons**
- **Existing flow**: Scale details are not documented yet.
...
**iii. Expectations**
- **Accessibility**: Enable non-technical Scale details are not documented yet.
...
**iv. Previous work**
- **Hermes Vseveral**: A straightforward implementation using GPT-several variants where users provided metadata and prompts. It used a "kitchen-sink" approach, treating all business needs and data as a single entity, which failed due to the complexity and volume of Swiggy's data.
...
- **Latency**: Average turnaround time of < several minutes.
...
- **Label freshness**: All labels are generated offline once per year, while online features are refreshed every minute.
### 6. Validation schema
